...
#define LINE1_MAX_HEIGHT 180.0f
#define LINE2_MAX_HEIGHT 100.0f
#define LINE3_MAX_HEIGHT 150.0f
#define LINE4_MAX_HEIGHT 80.0f
#define LINE5_MAX_HEIGHT 80.0f
#define LINE6_MAX_HEIGHT 80.0f
...
static state_t *init_app(char const *font_path) {
    ...
    app->lines[4].color = (color_t){0xee, 0x5d, 0x93};
    app->lines[5].color = (color_t){0xf9, 0xf5, 0x93};
    ...
    app->lines[4].max_height = LINE5_MAX_HEIGHT;
    app->lines[5].max_height = LINE6_MAX_HEIGHT;

    if (!load_state(app)) {
        int greet_index = rand() % (greetings_size - 1);
        int intro_index = rand() % (intros_size - 1);
        int name_index  = rand() % (names_size - 1);
        int hmate_index  = rand() % (hmate_size - 1);
